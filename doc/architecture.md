...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  app.py          →  webui へ再エクスポート               │
│  chat_logic.py   →  core + cli へ再エクスポート         │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
└────┬─────────────┘
     │
     ├─ OpenAI: [{"role":"system", "content":...}, ...history]
     │
     └─ Gemini: (system_prompt, history) tuple
     │
     ▼
┌──────────────────┐
│ core.py          │
...
└────┬─────────────┘
     │
     │ {token_count, max_context_length, is_estimated}
     ▼
┌──────────────────┐
│ UI Layer         │
│ - 表示更新       │
