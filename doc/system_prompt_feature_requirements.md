...
-   **`webui.py`**:
    ...
    -   テキストボックスの下に、現在の入力トークン数と最大トークン数を表示する `gr.Markdown` を追加する（例: `Token count: 128 / 4096`）。
